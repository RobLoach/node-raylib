...
declare const raylib: {
    ...
    LoadModel: (fileName: string) => models.Model;
    LoadModelFromMesh: (mesh: models.Mesh) => models.Model;
    UnloadModel: (model: models.Model) => void;
    LoadMeshes: (fileName: string, meshCount: number) => models.Mesh;
    ExportMesh: (mesh: models.Mesh, fileName: string) => void;
    UnloadMesh: (mesh: models.Mesh) => void;
    LoadMaterials: (fileName: string, materialCount: number) => models.Material;
    LoadMaterialDefault: () => models.Material;
    UnloadMaterial: (material: models.Material) => void;
    SetMaterialTexture: (material: models.Material, mapType: number, texture: texture.Texture2D) => void;
    SetModelMeshMaterial: (model: models.Model, meshId: number, materialId: number) => void;
    LoadModelAnimations: (fileName: string, animsCount: number) => models.ModelAnimation;
    UpdateModelAnimation: (model: models.Model, anim: models.ModelAnimation, frame: number) => void;
    UnloadModelAnimation: (anim: models.ModelAnimation) => void;
    IsModelAnimationValid: (model: models.Model, anim: models.ModelAnimation) => boolean;
    GenMeshPoly: (sides: number, radius: number) => models.Mesh;
    GenMeshPlane: (width: number, length: number, resX: number, resZ: number) => models.Mesh;
    GenMeshCube: (width: number, height: number, length: number) => models.Mesh;
    GenMeshSphere: (radius: number, rings: number, slices: number) => models.Mesh;
    GenMeshHemiSphere: (radius: number, rings: number, slices: number) => models.Mesh;
    GenMeshCylinder: (radius: number, height: number, slices: number) => models.Mesh;
    GenMeshTorus: (radius: number, size: number, radSeg: number, sides: number) => models.Mesh;
    GenMeshKnot: (radius: number, size: number, radSeg: number, sides: number) => models.Mesh;
    GenMeshHeightmap: (heightmap: texture.Image, size: maths.Vector3) => models.Mesh;
    GenMeshCubicmap: (cubicmap: texture.Image, cubeSize: maths.Vector3) => models.Mesh;
    MeshBoundingBox: (mesh: models.Mesh) => models.BoundingBox;
    MeshTangents: (mesh: models.Mesh) => void;
    MeshBinormals: (mesh: models.Mesh) => void;
    DrawModel: (model: models.Model, position: maths.Vector3, scale: number, tint: colors.Color) => void;
    DrawModelEx: (model: models.Model, position: maths.Vector3, rotationAxis: maths.Vector3, rotationAngle: number, scale: maths.Vector3, tint: colors.Color) => void;
    DrawModelWires: (model: models.Model, position: maths.Vector3, scale: number, tint: colors.Color) => void;
    DrawModelWiresEx: (model: models.Model, position: maths.Vector3, rotationAxis: maths.Vector3, rotationAngle: number, scale: maths.Vector3, tint: colors.Color) => void;
    DrawBoundingBox: (box: models.BoundingBox, color: colors.Color) => void;
    DrawBillboard: (camera: camera.Camera3D, texture: texture.Texture2D, center: maths.Vector3, size: number, tint: colors.Color) => void;
    DrawBillboardRec: (camera: camera.Camera3D, texture: texture.Texture2D, sourceRec: maths.Rectangle, center: maths.Vector3, size: number, tint: colors.Color) => void;
    CheckCollisionSpheres: (centerA: maths.Vector3, radiusA: number, centerB: maths.Vector3, radiusB: number) => boolean;
    CheckCollisionBoxes: (box1: models.BoundingBox, box2: models.BoundingBox) => boolean;
    CheckCollisionBoxSphere: (box: models.BoundingBox, centerSphere: maths.Vector3, radiusSphere: number) => boolean;
    CheckCollisionRaySphere: (ray: maths.Ray, spherePosition: maths.Vector3, sphereRadius: number) => boolean;
    CheckCollisionRaySphereEx: (ray: maths.Ray, spherePosition: maths.Vector3, sphereRadius: number, collisionPoint: maths.Vector3) => boolean;
    CheckCollisionRayBox: (ray: maths.Ray, box: models.BoundingBox) => boolean;
    GetCollisionRayModel: (ray: maths.Ray, model: models.Model) => maths.RayHitInfo;
    GetCollisionRayTriangle: (ray: maths.Ray, p1: maths.Vector3, p2: maths.Vector3, p3: maths.Vector3) => maths.RayHitInfo;
    GetCollisionRayGround: (ray: maths.Ray, groundHeight: number) => maths.RayHitInfo;
