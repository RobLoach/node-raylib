...
void node_raylib_bindings_defines(Napi::Env& env, Napi::Object& exports) {
  ...
  AddDefineInteger(env, exports, "KEY_NULL", KEY_NULL);
  ...
  AddDefineInteger(env, exports, "MOUSE_BUTTON_LEFT", MOUSE_BUTTON_LEFT);
  AddDefineInteger(env, exports, "MOUSE_BUTTON_RIGHT", MOUSE_BUTTON_RIGHT);
  AddDefineInteger(env, exports, "MOUSE_BUTTON_MIDDLE", MOUSE_BUTTON_MIDDLE);
  AddDefineInteger(env, exports, "MOUSE_BUTTON_SIDE", MOUSE_BUTTON_SIDE);
  AddDefineInteger(env, exports, "MOUSE_BUTTON_EXTRA", MOUSE_BUTTON_EXTRA);
  AddDefineInteger(env, exports, "MOUSE_BUTTON_FORWARD", MOUSE_BUTTON_FORWARD);
  AddDefineInteger(env, exports, "MOUSE_BUTTON_BACK", MOUSE_BUTTON_BACK);
  ...
  AddDefineInteger(env, exports, "MATERIAL_MAP_ALBEDO", MATERIAL_MAP_ALBEDO);
  AddDefineInteger(env, exports, "MATERIAL_MAP_METALNESS", MATERIAL_MAP_METALNESS);
  AddDefineInteger(env, exports, "MATERIAL_MAP_NORMAL", MATERIAL_MAP_NORMAL);
  AddDefineInteger(env, exports, "MATERIAL_MAP_ROUGHNESS", MATERIAL_MAP_ROUGHNESS);
  AddDefineInteger(env, exports, "MATERIAL_MAP_OCCLUSION", MATERIAL_MAP_OCCLUSION);
  AddDefineInteger(env, exports, "MATERIAL_MAP_EMISSION", MATERIAL_MAP_EMISSION);
  AddDefineInteger(env, exports, "MATERIAL_MAP_HEIGHT", MATERIAL_MAP_HEIGHT);
  AddDefineInteger(env, exports, "MATERIAL_MAP_CUBEMAP", MATERIAL_MAP_CUBEMAP);
  AddDefineInteger(env, exports, "MATERIAL_MAP_IRRADIANCE", MATERIAL_MAP_IRRADIANCE);
  AddDefineInteger(env, exports, "MATERIAL_MAP_PREFILTER", MATERIAL_MAP_PREFILTER);
  AddDefineInteger(env, exports, "MATERIAL_MAP_BRDF", MATERIAL_MAP_BRDF);
  AddDefineInteger(env, exports, "SHADER_LOC_VERTEX_POSITION", SHADER_LOC_VERTEX_POSITION);
  AddDefineInteger(env, exports, "SHADER_LOC_VERTEX_TEXCOORD01", SHADER_LOC_VERTEX_TEXCOORD01);
  AddDefineInteger(env, exports, "SHADER_LOC_VERTEX_TEXCOORD02", SHADER_LOC_VERTEX_TEXCOORD02);
  AddDefineInteger(env, exports, "SHADER_LOC_VERTEX_NORMAL", SHADER_LOC_VERTEX_NORMAL);
  AddDefineInteger(env, exports, "SHADER_LOC_VERTEX_TANGENT", SHADER_LOC_VERTEX_TANGENT);
  AddDefineInteger(env, exports, "SHADER_LOC_VERTEX_COLOR", SHADER_LOC_VERTEX_COLOR);
  AddDefineInteger(env, exports, "SHADER_LOC_MATRIX_MVP", SHADER_LOC_MATRIX_MVP);
  AddDefineInteger(env, exports, "SHADER_LOC_MATRIX_VIEW", SHADER_LOC_MATRIX_VIEW);
  AddDefineInteger(env, exports, "SHADER_LOC_MATRIX_PROJECTION", SHADER_LOC_MATRIX_PROJECTION);
  AddDefineInteger(env, exports, "SHADER_LOC_MATRIX_MODEL", SHADER_LOC_MATRIX_MODEL);
  AddDefineInteger(env, exports, "SHADER_LOC_MATRIX_NORMAL", SHADER_LOC_MATRIX_NORMAL);
  AddDefineInteger(env, exports, "SHADER_LOC_VECTOR_VIEW", SHADER_LOC_VECTOR_VIEW);
  AddDefineInteger(env, exports, "SHADER_LOC_COLOR_DIFFUSE", SHADER_LOC_COLOR_DIFFUSE);
  AddDefineInteger(env, exports, "SHADER_LOC_COLOR_SPECULAR", SHADER_LOC_COLOR_SPECULAR);
  AddDefineInteger(env, exports, "SHADER_LOC_COLOR_AMBIENT", SHADER_LOC_COLOR_AMBIENT);
  AddDefineInteger(env, exports, "SHADER_LOC_MAP_ALBEDO", SHADER_LOC_MAP_ALBEDO);
  AddDefineInteger(env, exports, "SHADER_LOC_MAP_METALNESS", SHADER_LOC_MAP_METALNESS);
  AddDefineInteger(env, exports, "SHADER_LOC_MAP_NORMAL", SHADER_LOC_MAP_NORMAL);
  AddDefineInteger(env, exports, "SHADER_LOC_MAP_ROUGHNESS", SHADER_LOC_MAP_ROUGHNESS);
  AddDefineInteger(env, exports, "SHADER_LOC_MAP_OCCLUSION", SHADER_LOC_MAP_OCCLUSION);
  AddDefineInteger(env, exports, "SHADER_LOC_MAP_EMISSION", SHADER_LOC_MAP_EMISSION);
  AddDefineInteger(env, exports, "SHADER_LOC_MAP_HEIGHT", SHADER_LOC_MAP_HEIGHT);
  AddDefineInteger(env, exports, "SHADER_LOC_MAP_CUBEMAP", SHADER_LOC_MAP_CUBEMAP);
  AddDefineInteger(env, exports, "SHADER_LOC_MAP_IRRADIANCE", SHADER_LOC_MAP_IRRADIANCE);
  AddDefineInteger(env, exports, "SHADER_LOC_MAP_PREFILTER", SHADER_LOC_MAP_PREFILTER);
  AddDefineInteger(env, exports, "SHADER_LOC_MAP_BRDF", SHADER_LOC_MAP_BRDF);
  AddDefineInteger(env, exports, "SHADER_UNIFORM_FLOAT", SHADER_UNIFORM_FLOAT);
  AddDefineInteger(env, exports, "SHADER_UNIFORM_VEC2", SHADER_UNIFORM_VEC2);
  AddDefineInteger(env, exports, "SHADER_UNIFORM_VEC3", SHADER_UNIFORM_VEC3);
  AddDefineInteger(env, exports, "SHADER_UNIFORM_VEC4", SHADER_UNIFORM_VEC4);
  AddDefineInteger(env, exports, "SHADER_UNIFORM_INT", SHADER_UNIFORM_INT);
  AddDefineInteger(env, exports, "SHADER_UNIFORM_IVEC2", SHADER_UNIFORM_IVEC2);
  AddDefineInteger(env, exports, "SHADER_UNIFORM_IVEC3", SHADER_UNIFORM_IVEC3);
  AddDefineInteger(env, exports, "SHADER_UNIFORM_IVEC4", SHADER_UNIFORM_IVEC4);
  AddDefineInteger(env, exports, "SHADER_UNIFORM_SAMPLER2D", SHADER_UNIFORM_SAMPLER2D);
  AddDefineInteger(env, exports, "SHADER_ATTRIB_FLOAT", SHADER_ATTRIB_FLOAT);
  AddDefineInteger(env, exports, "SHADER_ATTRIB_VEC2", SHADER_ATTRIB_VEC2);
  AddDefineInteger(env, exports, "SHADER_ATTRIB_VEC3", SHADER_ATTRIB_VEC3);
  AddDefineInteger(env, exports, "SHADER_ATTRIB_VEC4", SHADER_ATTRIB_VEC4);
  AddDefineInteger(env, exports, "PIXELFORMAT_UNCOMPRESSED_GRAYSCALE", PIXELFORMAT_UNCOMPRESSED_GRAYSCALE);
  AddDefineInteger(env, exports, "PIXELFORMAT_UNCOMPRESSED_GRAY_ALPHA", PIXELFORMAT_UNCOMPRESSED_GRAY_ALPHA);
  AddDefineInteger(env, exports, "PIXELFORMAT_UNCOMPRESSED_R5G6B5", PIXELFORMAT_UNCOMPRESSED_R5G6B5);
  AddDefineInteger(env, exports, "PIXELFORMAT_UNCOMPRESSED_R8G8B8", PIXELFORMAT_UNCOMPRESSED_R8G8B8);
  AddDefineInteger(env, exports, "PIXELFORMAT_UNCOMPRESSED_R5G5B5A1", PIXELFORMAT_UNCOMPRESSED_R5G5B5A1);
  AddDefineInteger(env, exports, "PIXELFORMAT_UNCOMPRESSED_R4G4B4A4", PIXELFORMAT_UNCOMPRESSED_R4G4B4A4);
  AddDefineInteger(env, exports, "PIXELFORMAT_UNCOMPRESSED_R8G8B8A8", PIXELFORMAT_UNCOMPRESSED_R8G8B8A8);
  AddDefineInteger(env, exports, "PIXELFORMAT_UNCOMPRESSED_R32", PIXELFORMAT_UNCOMPRESSED_R32);
  AddDefineInteger(env, exports, "PIXELFORMAT_UNCOMPRESSED_R32G32B32", PIXELFORMAT_UNCOMPRESSED_R32G32B32);
  AddDefineInteger(env, exports, "PIXELFORMAT_UNCOMPRESSED_R32G32B32A32", PIXELFORMAT_UNCOMPRESSED_R32G32B32A32);
  AddDefineInteger(env, exports, "PIXELFORMAT_COMPRESSED_DXT1_RGB", PIXELFORMAT_COMPRESSED_DXT1_RGB);
  AddDefineInteger(env, exports, "PIXELFORMAT_COMPRESSED_DXT1_RGBA", PIXELFORMAT_COMPRESSED_DXT1_RGBA);
  AddDefineInteger(env, exports, "PIXELFORMAT_COMPRESSED_DXT3_RGBA", PIXELFORMAT_COMPRESSED_DXT3_RGBA);
  AddDefineInteger(env, exports, "PIXELFORMAT_COMPRESSED_DXT5_RGBA", PIXELFORMAT_COMPRESSED_DXT5_RGBA);
  AddDefineInteger(env, exports, "PIXELFORMAT_COMPRESSED_ETC1_RGB", PIXELFORMAT_COMPRESSED_ETC1_RGB);
  AddDefineInteger(env, exports, "PIXELFORMAT_COMPRESSED_ETC2_RGB", PIXELFORMAT_COMPRESSED_ETC2_RGB);
  AddDefineInteger(env, exports, "PIXELFORMAT_COMPRESSED_ETC2_EAC_RGBA", PIXELFORMAT_COMPRESSED_ETC2_EAC_RGBA);
  AddDefineInteger(env, exports, "PIXELFORMAT_COMPRESSED_PVRT_RGB", PIXELFORMAT_COMPRESSED_PVRT_RGB);
  AddDefineInteger(env, exports, "PIXELFORMAT_COMPRESSED_PVRT_RGBA", PIXELFORMAT_COMPRESSED_PVRT_RGBA);
  AddDefineInteger(env, exports, "PIXELFORMAT_COMPRESSED_ASTC_4x4_RGBA", PIXELFORMAT_COMPRESSED_ASTC_4x4_RGBA);
  AddDefineInteger(env, exports, "PIXELFORMAT_COMPRESSED_ASTC_8x8_RGBA", PIXELFORMAT_COMPRESSED_ASTC_8x8_RGBA);
  AddDefineInteger(env, exports, "TEXTURE_FILTER_POINT", TEXTURE_FILTER_POINT);
  AddDefineInteger(env, exports, "TEXTURE_FILTER_BILINEAR", TEXTURE_FILTER_BILINEAR);
  AddDefineInteger(env, exports, "TEXTURE_FILTER_TRILINEAR", TEXTURE_FILTER_TRILINEAR);
  AddDefineInteger(env, exports, "TEXTURE_FILTER_ANISOTROPIC_4X", TEXTURE_FILTER_ANISOTROPIC_4X);
  AddDefineInteger(env, exports, "TEXTURE_FILTER_ANISOTROPIC_8X", TEXTURE_FILTER_ANISOTROPIC_8X);
  AddDefineInteger(env, exports, "TEXTURE_FILTER_ANISOTROPIC_16X", TEXTURE_FILTER_ANISOTROPIC_16X);
  AddDefineInteger(env, exports, "TEXTURE_WRAP_REPEAT", TEXTURE_WRAP_REPEAT);
  AddDefineInteger(env, exports, "TEXTURE_WRAP_CLAMP", TEXTURE_WRAP_CLAMP);
  AddDefineInteger(env, exports, "TEXTURE_WRAP_MIRROR_REPEAT", TEXTURE_WRAP_MIRROR_REPEAT);
  AddDefineInteger(env, exports, "TEXTURE_WRAP_MIRROR_CLAMP", TEXTURE_WRAP_MIRROR_CLAMP);
  AddDefineInteger(env, exports, "CUBEMAP_LAYOUT_AUTO_DETECT", CUBEMAP_LAYOUT_AUTO_DETECT);
  AddDefineInteger(env, exports, "CUBEMAP_LAYOUT_LINE_VERTICAL", CUBEMAP_LAYOUT_LINE_VERTICAL);
  AddDefineInteger(env, exports, "CUBEMAP_LAYOUT_LINE_HORIZONTAL", CUBEMAP_LAYOUT_LINE_HORIZONTAL);
  AddDefineInteger(env, exports, "CUBEMAP_LAYOUT_CROSS_THREE_BY_FOUR", CUBEMAP_LAYOUT_CROSS_THREE_BY_FOUR);
  AddDefineInteger(env, exports, "CUBEMAP_LAYOUT_CROSS_FOUR_BY_THREE", CUBEMAP_LAYOUT_CROSS_FOUR_BY_THREE);
  AddDefineInteger(env, exports, "CUBEMAP_LAYOUT_PANORAMA", CUBEMAP_LAYOUT_PANORAMA);
  ...
  AddDefineInteger(env, exports, "NPATCH_NINE_PATCH", NPATCH_NINE_PATCH);
...
void node_raylib_bindings_functions(Napi::Env& env, Napi::Object& exports) {
  ...
  AddFunction(env, exports, "GetImageColor", &GetImageColor);
